...
namespace Hotel.Address
{
    public partial class ListСountries : Form
    {
        ...
        {
            dbCommand.CommandText = "SELECT COUNT(*) FROM Countries";
        ...
        {
            Utility.selected_ID_Country = GetSelectedID();
            _formIsClosed = true;
            this.Close();
        }
